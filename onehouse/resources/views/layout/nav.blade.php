    ...
    <div class="section">
        <div class="nav">
            <div class="main-nav">
                <ul>
                    <li class="phase svg-phase1"><a href="/">
                            <div class="icon {{request()->is('/') ? 'active' : ''}}"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                    ...
                    <li class="phase svg-phase2">
                        <a href="/phase2">
                            <div class="icon {{request()->is('phase2') ? 'active' : ''}}"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                                    viewBox="0 -960 960 960" width="40px" fill="#fff">
                                    <path
                    ...
                    <li class="phase svg-phase3"><a href="/phase3">
                            <div class="icon {{request()->is('phase3') ? 'active' : ''}}"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                                    viewBox="0 -960 960 960" width="40px" fill="#fff">
                                    <path
                    ...
                    <li class="phase svg-phase4"><a href="/phase4">
                            <div class="icon {{request()->is('phase4') ? 'active' : ''}}"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                                    viewBox="0 -960 960 960" width="40px" fill="#fff">
                                    <path
                    ...
                    <li class="phase svg-phase5"><a href="/phase5">
                            <div class="icon {{request()->is('phase5') ? 'active' : ''}}"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                                    viewBox="0 -960 960 960" width="40px" fill="#fff">
                                    <path
            ...
            <div class="navigate">
                <nav>
                    <ul>
                        <li class="{{request()->is('phase5') ? 'active' : ''}}"><a href="/phase5"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                        ...
                        <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                                ...
                                </svg><span class="title">Setting</span></a></li>
                        <li><a href=""><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                                    viewBox="0 -960 960 960" width="40px" fill="#8C8C8C">
                                    <path
                                ...
                                </svg><span class="title">Logout</span></a></li>
