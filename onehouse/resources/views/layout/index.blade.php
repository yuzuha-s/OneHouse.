    ...
    <div class="auth-section">
        <div class="detail wrapper">
            <div class="appname wrapper">
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" height="110px" viewBox="0 -960 960 960" width="110px"
                        fill="#000">
                        <path
            ...
            <div class="subname"> <span>一度きりだから<br>OneHouse.でしっかり管理</span></div>


            <div class="auth-nav wrapper">
                <ul>
                    <li class="phase svg-phase1"><a href="#">
                            <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" height="60px"
                                    viewBox="0 -960 960 960" width="60px" fill="#fff">
                                    <path
                            ...
                            </div><span class="title">注文住宅が欲しい？</span>
                        </a></li>
                    ...
                    <li class="phase svg-phase2">
                        <a href="#">
                            ...
                            <span class="title">注文メーカーが決まった？</span>
                        </a>
                    </li>

                    <li class="phase svg-phase3"><a href="#">
                            <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" height="60px"
                                    viewBox="0 -960 960 960" width="60px" fill="#fff">
                                    <path
                                ...
                                </svg></div><span class="title">資金・ローンのめどは立った？</span>
                        </a></li>

                    <li class="phase svg-phase4"><a href="#">
                            <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" height="60px"
                                    viewBox="0 -960 960 960" width="60px" fill="#fff">
                                    <path
                                ...
                                </svg></div><span class="title">立てる土地を探す</span>
                        </a></li>

                    <li class="phase svg-phase5"><a href="#">
                            <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" height="60px"
                                    viewBox="0 -960 960 960" width="60px" fill="#fff">
                                    <path
                                ...
                                </svg></div><span class="title">理想の住まいを形にしよう！</span>
                        </a></li>
