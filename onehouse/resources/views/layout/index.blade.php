        ...
        <main class="contant">
            <div class="wrapper">
                ...
                <div class="main-nav">
                    <nav>
                        <ul>
                            <li class="phase1 svg-phase1"><a href=""><svg xmlns="http://www.w3.org/2000/svg"
                                        height="50px" viewBox="0 -960 960 960" width="50px" fill="#fff">
                                        <path
                            ...
                            <li class="phase2 svg-phase2"><a href=""><svg xmlns="http://www.w3.org/2000/svg"
                                        height="50px" viewBox="0 -960 960 960" width="50px" fill="#fff">
                                        <path
                            ...
                            <li class="phase3 svg-phase3"><a href=""><svg xmlns="http://www.w3.org/2000/svg"
                                        height="50px" viewBox="0 -960 960 960" width="50px" fill="#fff">
                                        <path
                            ...
                            <li class="phase4 svg-phase4"><a href=""><svg xmlns="http://www.w3.org/2000/svg"
                                        height="50px" viewBox="0 -960 960 960" width="50px" fill="#fff">
                                        <path
                            ...
                            <li class="phase5 svg-phase5"><a href=""><svg xmlns="http://www.w3.org/2000/svg"
                                        height="50px" viewBox="0 -960 960 960" width="50px" fill="#fff">
                                        <path
