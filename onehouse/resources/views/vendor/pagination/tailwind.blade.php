@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="paginate-wrapper">
            <span class="relative z-0 inline-flex justify-around items-center w-full shadow-sm rounded-md">
                {{-- Previous Page Link --}}
                @if ($paginator->onFirstPage())
                ...
                @foreach ($elements as $element)
                    ...
                    @if (is_string($element))
                        <span aria-disabled="true">
                            <span
                                class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600">{{ $element }}</span>
                        </span>
                    @endif
                ...
                @else
                    <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                        <span
                            ...
                            aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" height="80px" viewBox="0 -960 960 960"
                                width="80px" fill="#8C8C8C">
                                <path d="M480-344 240-584l47.33-47.33L480-438.67l192.67-192.66L720-584 480-344Z" />
                            </svg>
                        </span>
                    </span>
