    ...
    <div class="marker-list wrapper">
        <div class="cards">
            <div class="card-main">
                ...
                <div class="marker-liststar">★★★☆☆</div>

                <div class="visible">
                    <div class="visible-contain">
                        <div class="visible-groupe">
                            <p>工法・構造</p>
                            <button class="choice method">木造</button>
                        </div>
                        <div class="visible-groupe">
                            <p>耐熱性法・省エネ性</p>
                            <button class="choice heat-energy">等級6以上</button>
                        </div>
                    </div>
                    ...
                    <div class="visible-contain">
                        <div class="visible-groupe">
                            <p>耐震性</p>
                            <button class="choice earthquake">等級3</button>
                        </div>
                        <div class="visible-groupe">
                            <p>保証・アフターサービス</p>
                            <button class="choice after-servise">保証あり</button>
                            <button class="choice after-servise">アフターサービスあり</button>
                        </div>
                    </div>
                    ...
                    <div class="visible-contain">
                        <div class="visible-groupe">
                            <p>デザイン間取りの自由度</p>
                            <button class="choice design">セミオーダー</button>
                        </div>
                        <div class="visible-groupe">
                            <p>ブランド力</p>
                            <button class="choice brand">品質</button>
                        </div>
                    </div>

                    <div class="visible-groupe">
                        <p>そのほかオプション</p>
                        <textarea name="" id="" class="option">太陽光・さらポカ完備</textarea>
                    </div>
        ...
        <div class="cards">
            <div class="card-main">追加する＋</div>
            <div class="marker-listnav"></div>
